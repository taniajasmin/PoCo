...
<div class="row container-fluid">
	...
	<div class="col-md-2 container-fluid">
		<?php
			...
			$table = div(div(par("Subscribed subs"), "panel-heading cust-panel-header"), "panel cust_panel");
			$table["children"][] = $t;
			echo to_html($table);
        ...
        <?php
            ...
            $table = div(div(par("Subs"), "panel-heading cust-panel-header"), "panel cust_panel");
            $table["children"][] = $t;
            echo to_html($table);

        ?>
		<a data-toggle="modal" data-target="#new-soc" class="btn btn-poco btn-large form-control" >Create a Sub</a>
	</div>
</div>
